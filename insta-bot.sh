#!/bin/bash
# insta-bot v3.0
# recoded by: Edwin Shaju
# github.com/adwin-15/insta-bot
...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92mEdwin Shaju"
...
adwin_15="6709858461"
dualipa="12331195"
keralafollows="48153177286"
kerala_likers="50465877031"
kerala_booster="48741703241"
...
if [[ ! -e celeb_id ]]; then
printf " %s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $dualipa $celebrity $mileycyrus $shawnmendes $katyperry $charlieputh $lelepons $camila_cabello $madonna $leonardodicaprio $ladygaga $taylorswift $instagram $neymar $selena $ariana $beyonce $professor $cristiano $kimkardashian $kendall $therock $kylie $jelopez $messi $keralafollows $adwin_15 $kerala_likers $kerala_booster > celeb_id
fi
